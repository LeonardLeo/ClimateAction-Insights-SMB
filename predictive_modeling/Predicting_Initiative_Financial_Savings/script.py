...
regression_models = {
    ...
    "Gradient Boosting": GradientBoostingRegressor(n_estimators=50, learning_rate=0.2, max_depth=2, random_state=42),
...
for name, model in regression_models.items():
    ...
    each_model = run_regression_model(dataframe = data,
                                      X = data.drop("initiative_financial_savings_GBP_log1p", axis = 1),
                                      y = data.initiative_financial_savings_GBP_log1p,
